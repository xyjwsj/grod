...
// Doc for environment variables: https://pkg.go.dev/github.com/xyjwsj/grod/lib/defaults
...
// List of cdp API: https://github.com/xyjwsj/grod/tree/main/lib/proto
...
func Example_load_extension() {
	...
	u := launcher.New().
		...
		// You can use XVFB to get rid of it: https://github.com/xyjwsj/grod/blob/main/lib/examples/launch-managed/main.go
		Headless(false).
		MustLaunch()
