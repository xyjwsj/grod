...
[![Go Reference](https://pkg.go.dev/badge/github.com/xyjwsj/grod.svg)](https://pkg.go.dev/github.com/xyjwsj/grod)
[![Discord Chat](https://img.shields.io/discord/719933559456006165.svg)][discord room]

## [Documentation](https://go-rod.github.io/) | [API reference](https://pkg.go.dev/github.com/xyjwsj/grod?tab=doc) | [FAQ](https://go-rod.github.io/#/faq/README)
...
- [CI](https://github.com/xyjwsj/grod/actions) enforced 100% test coverage
...
for example, use GitHub online [search in repository](https://github.com/xyjwsj/grod/search?q=HandleAuth&unscoped_q=HandleAuth).
You can also search the GitHub [issues](https://github.com/xyjwsj/grod/issues) or [discussions](https://github.com/xyjwsj/grod/discussions),
...
If you have questions, please raise an [issues](https://github.com/xyjwsj/grod/issues)/[discussions](https://github.com/xyjwsj/grod/discussions) or join the [chat room][discord room].
...
We use GitHub Projects to manage tasks, you can see the priority and progress of the issues [here](https://github.com/xyjwsj/grod/projects).
